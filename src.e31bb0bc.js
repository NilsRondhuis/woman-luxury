...
var _default = {
  ...
  productOrderBtn: document.querySelector(".product-order-btn"),
  boxBtnSize: document.querySelector(".box-btn-size"),
...
_refs.default.heroOrderBtn.addEventListener("click", onClickScrollProduct);

_refs.default.productOrderBtn.addEventListener("click", onClickScrollForm);

function onClickScrollProduct() {
  (0, _scroll.default)(_refs.default.sectionProduct);
}

function onClickScrollForm() {
  const currentBtnSize = document.querySelector(".size-btn__is-current");
  _refs.default.textarea.value = "";

  if (currentBtnSize) {
    const size = currentBtnSize.textContent;
    _refs.default.textarea.value = `Розмір: ${size}`;
  }
...
const reviews = new _swiper.default(".reviews-slider", {
  pagination: {
    el: ".swiper-pagination",
    clickable: true
  }
...
_refs.default.boxBtnSize.addEventListener("click", onClickBtnSize);
...
},{"./common/refs":"js/common/refs.js"}],"js/form/form-effects.js":[function(require,module,exports) {
"use strict";
...
},{"../common/refs":"js/common/refs.js","./form-messages":"js/form/form-messages.js"}],"../node_modules/lodash.throttle/index.js":[function(require,module,exports) {
...
function onShowUpBtn() {
  ...
  if (rect.y < -900) {
    _refs.default.upBtn.classList.add("btn-up__is-show");
  } else _refs.default.upBtn.classList.remove("btn-up__is-show");
}
},{"lodash.throttle":"../node_modules/lodash.throttle/index.js","./common/refs":"js/common/refs.js","./common/scroll":"js/common/scroll.js"}],"index.js":[function(require,module,exports) {
"use strict";
